        ...
        title: RichText(
          text: TextSpan(
            ...
            children: [
              ...
              const TextSpan(text: ' - Add Inventory', style: TextStyle(color: Colors.black54, fontSize: 16, fontWeight: FontWeight.w600)),
            ],
          ),
        ),
      ),
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            Expanded(child: Text(acquiredDate == null ? 'Optional' : '${acquiredDate!.month}/${acquiredDate!.day}/${acquiredDate!.year}', style: TextStyle(color: acquiredDate == null ? Colors.black38 : Colors.black87, fontSize: 13, fontWeight: acquiredDate == null ? FontWeight.normal : FontWeight.w600))),
