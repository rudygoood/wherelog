      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            buildLocationField(controller: generalController, focusNode: generalFocus, hint: 'e.g. Garage, Attic', isTier1: true, enabled: true, onPickerTap: openGeneralPicker, onAddTap: () => addGeneral(generalController.text.trim()), existing: inventoryGeneralList),
            const SizedBox(height: 12),
